...
void rt_OneStep(void)
{
  ...
  __enable_irq();
  currentTime = (extmodeSimulationTime_T) e_M->Timing.taskTime0;
  e_step();
...
int main(int argc, char **argv)
{
  ...
  errorCode = extmodeInit(e_M->extModeInfo, &rtmGetTFinal(e_M));
  if (errorCode != EXTMODE_SUCCESS) {
